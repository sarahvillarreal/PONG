...
public class Pelota {
   ...
   public Ellipse2D getPelota() {
    ...
    private void incrementarVelocidad() {
        velocidad *= 1.05; // Incremento progresivo: cuanto más alta sea la velocidad, más pequeño es el incremento
        if (velocidad > 3) {
            velocidad = 3;
        }
        //System.out.println("Nueva velocidad: " + velocidad); // Para comprobar
    }
